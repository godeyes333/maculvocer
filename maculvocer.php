...
echo ""
echo "\033[32;1m ──> \033[32;1m Pilih langsung wae rasah cerewet!\033[32;1m"
...
echo "arep macul pulsa piro.?"
read -p "(ex:5000, 10000 dan seterusnya)=> " pulsa
echo ""
echo ""
echo "nomor lu"
read -p "nomor pake +62 eaa =>" nomor
...
echo "mau isiin pulsa temen kamu eaa"
echo "mau send pulsa brp.?"
read -p "(ex:5000, 10000 dan seterusnya)=> " a
echo ""
echo ""
echo "OPERATOR"
read -p "(ex:Indosat,3 , dll=> " b
echo ""
echo ""
echo "nomor tujuan"
read -p "=>" c
